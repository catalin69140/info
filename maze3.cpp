...
const char height=21,width=25;
char prizonier='@',enemy1='K',enemy2='F',enemy3='P',goal='G',cheie='C';     ///Simbolurile care apar in labirint
int prizonierPOZx=1,prizonierPOZy=1,goalPOZx=18,goalPOZy=23/*,cheiePOZx=18,cheiePOZy=1*/,gasit=false;      ///Pozitia prizonierului si pozitia libertatii lui
...
int spawnENEMY1()                                            ///O functie ce va genera primul tau tip de inamici
{
    ...
    srand(time(NULL));                                          ///O functie ce va genera un numar aleatoriu

    int enemy1SPAWNpointX=myenemy1.x;
    enemy1SPAWNpointX=(rand()%23)+1;                         ///Genereaza un numar de la 0-18(unde se va plasa inamicul pe axa X) + 1.

    int enemy1SPAWNpointY=myenemy1.y;
    enemy1SPAWNpointY=(rand()%18)+1;                         ///Genereaza un numar de la 0-23(unde se va plasa inamicul pe axa Y) + 1.
    ...
    if(escapePLAN[enemy1SPAWNpointX][enemy1SPAWNpointY]!='#')            ///Conditie de a nu genera inamicul in peretii inchisorii('#') sau pe prizonier('@').
    {
        ...
        {
            escapePLAN[enemy1SPAWNpointY-1][enemy1SPAWNpointX]=enemy1;
        }
    }
    return 0;
}
...
int spawnENEMY2()                                             ///O functie ce va genera primul tau tip de inamici
{
    ...
    enemy2SPAWNpointX=(rand()%23)+2;                         ///Genereaza un numar de la 0-18(unde se va plasa inamicul pe axa X) + 1.

    int enemy2SPAWNpointY=myenemy2.y;
    enemy2SPAWNpointY=(rand()%18)+2;                         ///Genereaza un numar de la 0-23(unde se va plasa inamicul pe axa Y) + 1.
    ...
    if(escapePLAN[enemy2SPAWNpointX][enemy2SPAWNpointY]!='#')            ///Conditie de a nu genera inamicul in peretii inchisorii('#') sau pe prizonier('@').
    {
        ...
        {
            escapePLAN[enemy2SPAWNpointY-1][enemy2SPAWNpointX]=enemy2;
        }
    }
    return 0;
}
...
int spawnENEMY3()                                             ///O functie ce va genera primul tau tip de inamici
{
    ...
    enemy3SPAWNpointX=(rand()%23)+3;                         ///Genereaza un numar de la 0-18(unde se va plasa inamicul pe axa X) + 1.

    int enemy3SPAWNpointY=myenemy3.y;
    enemy3SPAWNpointY=(rand()%18)+3;                         ///Genereaza un numar de la 0-23(unde se va plasa inamicul pe axa Y) + 1.
    ...
    if(escapePLAN[enemy3SPAWNpointX][enemy3SPAWNpointY]!='#')            ///Conditie de a nu genera inamicul in peretii inchisorii('#') sau pe prizonier('@').
    {
        ...
        {
            escapePLAN[enemy3SPAWNpointY-1][enemy3SPAWNpointX]=enemy3;
        }
    }
    return 0;
}
...
int prizonierDIRECTION()
{
    ...
    for(i=1; i>0; i++)
    {
        cout<<"Alege o directie : ";
        ch=getchar();
        if(ch=='w')                                                              ///Cazul in care este apasata tasta 'w'.
        {
            if(escapePLAN[prizonierPOZx][prizonierPOZy]==enemy1)             ///Cazul in care intalneste vanatorul de recompense.
            {
                escapePLAN[prizonierPOZx-1][prizonierPOZy]=' ';            ///Creeaza un spatiu unde sta prizonierul.
                for(i=0; i<6; i++)
                {
        ...
        else if(ch=='s')                                                            ///Cazul in care este apasata tasta 'w'.
        {
            if(escapePLAN[prizonierPOZx+1][prizonierPOZy]==enemy1)             ///Cazul in care intalneste vanatorul de recompense.
            {
                escapePLAN[prizonierPOZx][prizonierPOZy]=' ';            ///Creeaza un spatiu unde sta prizonierul.
                for(;;)
                {
        ...
        else if(ch=='a')                                                            ///Cazul in care este apasata tasta 'w'.
        {
            if(escapePLAN[prizonierPOZx][prizonierPOZy-1]==enemy1)             ///Cazul in care intalneste vanatorul de recompense.
            {
                escapePLAN[prizonierPOZx][prizonierPOZy]=' ';            ///Creeaza un spatiu unde sta prizonierul.
                for(;;)
                {
            ...
            if(escapePLAN[prizonierPOZx][prizonierPOZy]==cheie)
            {
                gasit=true;
            }
            //cout<<"Alege o directie : ";
        }
        else if(ch=='d')                                                            ///Cazul in care este apasata tasta 'w'.
        {
            if(escapePLAN[prizonierPOZx][prizonierPOZy+1]==enemy1)             ///Cazul in care intalneste vanatorul de recompense.
            {
                escapePLAN[prizonierPOZx][prizonierPOZy]=' ';            ///Creeaza un spatiu unde sta prizonierul.
            ...
            if(escapePLAN[prizonierPOZx][prizonierPOZy]==goal)
            {
                ...
                {
                    cout<<"Nu ai gasit cheia!!!Incearca dupa ce o gasesti."<<'\n';
                }
            }
            //cout<<"Alege o directie : ";
        }
...
int main()
{
    ...
    cout<<'\n';
    cout<<"   -C(cheie):Cauta cheia pentru a deschida usa.";
    cout<<'\n';
    //delay(3);
    spawnENEMY1();
    spawnENEMY2();
